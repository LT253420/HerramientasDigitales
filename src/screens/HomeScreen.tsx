...
import { Wrench, Search, Smartphone, ListChecks, Phone, NotebookText, HelpCircle, Contact } from 'lucide-react';
  ...
  const menuItems = [
    {
      ...
      description: 'Accede a la lista completa de Herramientas digitales',
      icon: <Search size={24} />,
    ...
    },
    {
    ...
    },
     {
      ...
      description: 'acceso a la lista de fallas',
      icon: <ListChecks size={24} />,
      action: () => window.location.href = 'https://listadefallas.vercel.app' ,
      variant: 'secondary' as const,
    },
      {
      id: 'serviceCode',
      title: 'Códigos de servicio',
      description: 'Códigos de servicio para Celulares',
      icon: <Smartphone size={24} />,
      action: () => onNavigate('serviceCode'),
      variant: 'secondary' as const,
    },
    {
      id: 'contact',
      ...
      <main className="flex-1 pt-24 pb-8 px-4">
        <div className="max-w-md mx-auto w-full space-y-6">
          ...
          <div className="text-center mb-8 animate-fadeInUp">
            ...
            >
             {/* Acá Va el ICONO PRINCIPAL*/}
              <NotebookText size={28} className="text-[var(--color-primary)]" />
            </div>
          ...
          >
            ...
            >
              ...
              <div className="text-xs text-[var(--text-muted)]">Diario</div>
            </div>
            <div
              className={cn(
                'text-center p-4 rounded-xl',
            ...
            >
              ...
              <div className="text-xs text-[var(--text-muted)]">Páginas</div>
            </div>
            <div
              className={cn(
                'text-center p-4 rounded-xl',
        ...
        <div className="max-w-md mx-auto w-full space-y-6">
          ...
          <Card variant="glow" padding="lg" className="animate-fadeInUp">
            ...
            <div className="space-y-4 text-[var(--text-secondary)] leading-relaxed">
              <p>
                Esta es una lista para recopilar páginas Web o utilidades que solemos utilizar cotidianamente en la reparación de celulares y servicio técnico, pero en un solo lugar y tener acceso con un solo clic.
              </p>

              <p>
                Es Simple, Vas a encontrar diferentes páginas, con su categorías y funciones en cada botón.
              </p>
              <p>
               Solo hacés clic y te redirige a la página correspondiente.
              </p>
              ...
              >
                ...
                <ul className="list-disc list-inside mt-2 space-y-1 text-sm">
                   <li>Los códigos de servicio pueden variar según modelo, Marca y año del equipo. 
                    por lo que puede ser que en algunos casos no funcionen.</li>
                   <li>Los codigos de servicio SON PRIVADOS para el servicio tecnico. Estos no deben compartirse.</li>
                   <li>Muchos técnicos no conocen varios códigos, por lo que la lista es un <b>privilegio 
                    EXCLUSIVO por trabajar con nosotros y Así debe mantenerse</b></li>
                </ul>
              </div>

              <p className="text-sm text-[var(--text-muted)]">
                Puede ser que alguna página o código quede en desUso o desactualizada. Si es el caso, Podés Contactar Al Whatsapp para notificarlo.
              </p>
            </div>
          </Card>
        </div>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <p className="text-sm text-[var(--text-secondary)]">
                  Te gustaría colaborar? Hacé tu aporte al whatsapp sobre páginas, 
                  utilidades ONLINE o ideas que tengas para que la lista crezcá!
                </p>
                <p>También, si necesitás ayuda o tenés algun inconveniente con la lista, te podemos ayudar ;)</p>
              </div>
            </div>
          </Card>
        </div>
